...
export const projectSections = [
    {
        ...
        moreDescription: "E-commerce Redesign & UX Optimization : 브랜드 아이덴티티를 반영한 UI 리뉴얼 및 사용자 중심의 인터페이스 재설계\nCloud Database Integration : Firebase를 활용한 실시간 데이터 바인딩 및 장바구니/찜하기 등의 동적 데이터 처리 로직 구현\nEfficient Product Filtering : 카테고리별 실시간 상품 필터링 기능을 구축하여 정보 탐색 효율성 극대화\nFull Responsive Architecture : 유동적 레이아웃 설계를 통해 데스크톱, 태블릿, 모바일을 아우르는 일관된 사용자 경험 제공\nImage Asset Management : Cloudinary 등 외부 스토리지를 활용한 대용량 이미지 로딩 최적화 및 고해상도 비주얼 구현",
    ...
    },
    {
        ...
        moreDescription: "GSAP & ScrollTrigger : 서킷 드로잉 및 차량 이동 애니메이션으로 브랜드 정체성 강화\nReal - time Countdown : 경기 일정에 맞춘 D-Day 카운트다운 시스템 구축\nInteractive UI : 마우스 / 터치 좌표를 활용한 랜덤 이미지 제너레이팅 섹션 개발\nResponsive Design : 모바일 터치 인터랙션 최적화 및 적응형 레이아웃 구현",
    ...
    },
    {
        ...
        moreDescription: "API Data Integration & Processing : Nookipedia 외부 API 연동을 통한 실시간 데이터 패칭 및 비동기 통신 로직 구축\nGame-Inspired Interface Design : 인게임 UI/UX 요소를 재해석한 테마 디자인 및 사용자 경험(UX) 중심의 인터페이스 설계\nAdvanced Search & Filtering System : 동물 주민, 도구, 제작 재료 등 다각도 카테고리 필터링 및 실시간 검색 기능 구현\nAsset Branding & Consistency : 게임 특유의 톤앤매너를 유지하기 위한 커스텀 컴포넌트 제작 및 일관된 시각적 브랜딩 적용\nInteractive Content Exploration : 사용자가 직관적으로 정보를 탐색할 수 있도록 설계된 콘텐츠 레이아웃 및 상호작용 최적화",
    ...
    },
    {
        ...
        moreDescription: "UI/UX Reverse Engineering : 기존 웹사이트의 레이아웃 구조와 디자인 시스템을 분석하여 픽셀 단위의 정교한 클론 구현\nDynamic Tab Interface : State 제어를 통한 탭 메뉴 전환 로직 구현 및 컨텐츠 렌더링 최적화\nAdaptive Responsive Layout : 미디어 쿼리를 활용해 다양한 디바이스 환경에 최적화된 적응형 웹 구조 설계\nComponent-Based Architecture : 재사용 가능한 UI 컴포넌트 설계를 통한 코드의 유지보수성 및 일관성 확보\nVisual Asset Optimization : 아티스트 이미지와 영상을 활용한 시각적 완성도 유지 및 브라우저 성능 고려",
    ...
    },
    {
        ...
        moreDescription: "Brand Identity & Character Design : 동물 환경 보호 단체 'PEAT'의 브랜드 로고 및 4종의 메인 캐릭터 아이덴티티 독자 개발\nMain Page Design & Development (100%) : 메인 페이지의 UI/UX 기획, 디자인 및 프론트엔드 퍼블리싱 전과정 단독 수행\nDynamic Interaction Design : 스크롤 위치에 반응하는 실시간 숫자 카운팅(Number Animation) 효과 구현\nGoods Page Development (70%) : 굿즈 판매 페이지의 기능 구현을 통한 프로젝트 기여\nVisual Storytelling : 브랜드 캐릭터를 활용한 시각적 스토리텔링으로 단체의 메시지를 효과적으로 전달하는 인터페이스 구축",
